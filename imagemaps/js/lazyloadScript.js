 ...
 * @return {void}
 */
const toggleFunction = (megaMenu, svg) => {
 ...
 * @return {void}
 */
const closeMegaMenu = (megaMenu, svg) => {
	megaMenu.classList.remove("entrance-show");
	svg.style.rotate = "0deg";
};

const scrollFunction = (element) => {
	element.classList.toggle("reveal", window.scrollY > 300);
	// element.style.transform = window.scrollY > 300 ? "0" : "-20rem";
};

export { toggleFunction, closeMegaMenu, scrollFunction };
